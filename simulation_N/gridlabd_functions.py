...
from HH_global import results_folder, flexible_houses, p_max, market_data, control_room_data, which_price
from HH_global import interval, prec, price_intervals, allocation_rule, unresp_factor, load_forecast
from HH_global import FIXED_TARIFF, RR, include_SO, EV_data
from HH_global import input_folder, fixed_procurement_cost, coincident_peak_rate, system_op, customer_op

# quantity bids are in [kW]
# price bids are in [USD/MWh]
