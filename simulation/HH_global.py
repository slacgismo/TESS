...
start_time_str = '2021-07-22 09:47:00' # GREENWICH simulation start at local computer (in Greenwhich; if offline data is used, if not choose any)
start_time_db = '2021-07-22 09:47:00' #start of db (if offline data is used, if not choose == start_time_str)
