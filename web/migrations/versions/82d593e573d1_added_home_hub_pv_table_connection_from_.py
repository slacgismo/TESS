...
def upgrade():
    ...
    sa.Column('is_active', sa.Boolean(create_constraint=False), default=False, nullable=False),
    sa.Column('is_archived', sa.Boolean(create_constraint=False), default=False, nullable=False),
