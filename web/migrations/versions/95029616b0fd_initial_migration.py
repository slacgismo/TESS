...
Revision ID: 95029616b0fd
Revises: 
Create Date: 2020-06-24 08:22:34.320869
...
def upgrade():
    ...
    op.create_table(
        'service_locations',
        sa.Column('service_location_id',
                  sa.Integer(),
                  autoincrement=True,
                  nullable=False),
        sa.Column('alternate_service_location_id',
                  sa.String(length=64),
                  nullable=True),
    ...
    op.create_table(
        ...
        ), sa.PrimaryKeyConstraint('id'), sa.UniqueConstraint('address_id'),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['service_location_id'],
            ['service_locations.service_location_id'],
        ), sa.PrimaryKeyConstraint('home_hub_id'),
        sa.UniqueConstraint('service_location_id'))
    op.create_table(
        'logins',
        sa.Column('login_id', sa.Integer(), autoincrement=True,
                  nullable=False),
        sa.Column('user_id', sa.Integer(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ['user_id'],
            ['users.id'],
        ), sa.PrimaryKeyConstraint('login_id'), sa.UniqueConstraint('user_id'),
        sa.UniqueConstraint('username'))
    op.create_table(
        'meters',
        sa.Column('meter_id', sa.Integer(), autoincrement=True,
                  nullable=False),
        sa.Column('utility_id', sa.Integer(), nullable=False),
        sa.Column('service_location_id', sa.Integer(), nullable=False),
        ...
        sa.PrimaryKeyConstraint('meter_id', 'utility_id',
                                'service_location_id'),
    ...
    op.create_table(
        ...
        sa.UniqueConstraint('home_hub_id'), sa.UniqueConstraint('meter_id'))
