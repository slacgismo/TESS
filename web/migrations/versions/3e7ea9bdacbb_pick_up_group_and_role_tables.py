...
def upgrade():
    ...
    op.add_column('users', sa.Column('utility_id', sa.Integer(), nullable=False))
    op.alter_column('users', 'email_confirmed_at',
               existing_type=mysql.TIMESTAMP(),
               nullable=True)
    op.create_foreign_key(None, 'users', 'utilities', ['utility_id'], ['utility_id'])
